...
namespace DemoDB1.Models
{
    ...
    public class Cart
    {
        ...
        public void Update_quantity(int id, int _new_quan)
        {
            ...
            if (item != null)
            {
                if (items.Find(s => s._product.Quantity > _new_quan) != null) //nếu số lượng mua nhỏ hơn lượng tồn
                    item._quantity = _new_quan; //thì chấp nhận số lượng mua
                else item._quantity = 1; //ngược lại, số lượng mua trả lại 1
            }
        }
